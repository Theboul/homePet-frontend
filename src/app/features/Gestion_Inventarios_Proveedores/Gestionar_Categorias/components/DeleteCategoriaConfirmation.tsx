...
interface DeleteCategoriaConfirmationProps {
  open: boolean
...
export function DeleteCategoriaConfirmation({
  open,
  onOpenChange,
  onConfirm,
  isLoading = false,
}: DeleteCategoriaConfirmationProps) {
  return (
      ...
      >
        ...
        <div className="space-y-5 bg-white px-6 py-6">
          <p className="text-sm leading-relaxed text-slate-600">
            Se eliminará la categoría seleccionada y todos sus productos
            asociados quedarán sin clasificación.
          </p>
