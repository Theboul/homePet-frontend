...
interface DeleteProveedorConfirmationProps {
  open: boolean
...
export function DeleteProveedorConfirmation({
  open,
  onOpenChange,
  onConfirm,
  isLoading = false,
}: DeleteProveedorConfirmationProps) {
  return (
      ...
      >
        ...
        <div className="space-y-5 bg-white px-6 py-6">
          <p className="text-sm leading-relaxed text-slate-600">
            Se eliminará el proveedor seleccionado, pero los productos asociados
