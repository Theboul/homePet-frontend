...
interface DeleteServicioConfirmationProps {
  open: boolean
...
export function DeleteServicioConfirmation({
  open,
  onOpenChange,
  servicio,
  onConfirm,
  isLoading = false,
}: DeleteServicioConfirmationProps) {
  if (!open) return null

  const actionLabel = servicio?.estado ? 'Desactivar' : 'Activar'
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Se cambiará el estado del servicio{' '}
